...
90M Team locked up for 5 years for Future developments.
23% Suppy Total. NO MORE [2024 Update]


$SHRK was  the first ZRC-2 token available on Zilswap.https://zilswap.io/swap  
$SHRK will start off as Universal ZRC-2 leverage exchange token that will create a future of frictionless arbitrage opportunities around the world,
 which in turn increases volume, that increases Price.  
...
this is why $SHRK runs on the robust backbone of Zilliqa’s blockchain on Scilla to keep fees and friction to a minimum. 
...
$SHRK is able to process multiple transactions in a decentralized manner without a trusted coordinator through distributed ledger &
Its network architecture allows the platform to remain decentralized as it continues to grow and expand with Lowest fees!
...
Lock up 90 million for future developments unlocked in 5 years [1 year Left]

Top 4 wallet address Locked 90 million :    
Treasury Wallets:
...
Comprehensive real-time and historical analytics,
including, Crypto Charts, Crypto balances, with Interest payments
User freindly Websites.  
$VBS Supply 6M
...
The most active SHRK trading exchange is Zilswap
The addresses and transactions of SHRK can be explored at/https://viewblock.io/zilliqa/0xf2e1bf811317d26802b966f5356966da8df0d2f9
 
sharkfinancials.crypto     Unstoppable
